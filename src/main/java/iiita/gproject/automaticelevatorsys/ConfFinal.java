 ...
 * @author anshverma
 */
public class ConfFinal extends javax.swing.JFrame {

    String authName= "admin", authPass="Password" ;
    
    public ConfFinal(gotcha t) {
        temp= t;
        initComponents();
    }
    ...
    private void initComponents1() {
        ...
        ImageIcon imageIcon = new javax.swing.ImageIcon(getClass().getResource("/admin2.png")); // NOI18N
    ...
    private void initComponents() {
        ...
        ImageIcon imageIcon = new javax.swing.ImageIcon(getClass().getResource("/conf12.png")); // NOI18N
        Image image = imageIcon.getImage(); // transform it 
    ...
    private void initComponents2() {
        ...
        ImageIcon imageIcon = new javax.swing.ImageIcon(getClass().getResource("/people1.png")); // NOI18N
        Image image = imageIcon.getImage(); // transform it 
        Image newimg = image.getScaledInstance(50, 50,  java.awt.Image.SCALE_SMOOTH); // scale it the smooth way  
        imageIcon = new ImageIcon(newimg);  // transform it back
        ...
        imageIcon= new javax.swing.ImageIcon(getClass().getResource("/weight1.png")); // NOI18N
        ...
        imageIcon= new javax.swing.ImageIcon(getClass().getResource("/admin4.png")); // NOI18N
        image = imageIcon.getImage();
        newimg = image.getScaledInstance(50, 50,  java.awt.Image.SCALE_SMOOTH);
        imageIcon = new ImageIcon(newimg);
	...
	String recpt=null;
        ...
        jFormattedTextField1.setText(recpt);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        this.initComponents();       // TODO add your handling code here:
        validate();
        repaint();
    }                                        
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if(name.equals(authName) && pass.equals(authPass))
        {
            this.getContentPane().removeAll();
        ...
        else
        {
            ...
            this.getContentPane().removeAll();
            this.initComponents1();       // TODO add your handling code here:
            validate();
            repaint();//
        }
    }  
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        String num= jComboBox3.getSelectedItem().toString();      // TODO add your handling code here:
        ...
        else
        {
            ...
            this.getContentPane().removeAll();
            this.initComponents2();       // TODO add your handling code here:
            validate();
            repaint();
        }
    }  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfFinal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
